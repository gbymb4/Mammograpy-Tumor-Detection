...
class RCNNOptimiser:
    ...
    def execute(
        ...
        if len(kwargs) == 0:
            optim = optim_type(self.model.parameters(), lr=1e-3, momentum=0.9, weight_decay=5e-4)
        else:
            optim = optim_type(self.model.parameters(), **kwargs)
        ...
        for epoch in range(1, epochs + 1):
            ...
            for i, batch in enumerate(self.train_loader):
                ...
                if i == 0 and epoch % 5 == 0:
                    ...
                    fig, axs = plt.subplots(len(batch), 1, figsize=(10, len(batch) * 10))
                    ...
                    fig.suptitle('Training', fontsize=100)
            ...
            for i, batch in enumerate(self.test_loader):
                ...
                if i == 0 and epoch % 5 == 0:
                    ...
                    fig.suptitle('Testing', fontsize=100)
